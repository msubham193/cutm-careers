        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            <div className="flex items-center mb-4">
              ...
              <div>
                <h3 className="font-bold text-lg">Centurion University</h3>
                <p className="text-sm text-gray-300">of Technology and Management</p>
              </div>
            </div>
            <p className="text-gray-300 mb-4">
              Transforming lives through industry-integrated, skill-based education.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white transition duration-300">Research</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition duration-300">Contact</a></li>
            </ul>
          </div>
          
          <div>
            <h3 className="text-lg font-semibold mb-4">Campuses</h3>
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-300 hover:text-white transition duration-300">Bhubaneswar</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition duration-300">Paralakhemundi</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition duration-300">Vizianagaram</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition duration-300">Balangir</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition duration-300">Rayagada</a></li>
            </ul>
          </div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-gray-300">
                  Centurion University, Bhubaneswar, Odisha, India - 752050
                </span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-300">careers@cutm.ac.in</span>
              </li>
            </ul>
          </div>
        </div>
